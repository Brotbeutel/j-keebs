...
- [ ] Planner: review P0-B/P0-C/P1/map output, decide next package (P1 structure vs. the proposal-only Eleventy discussion vs. Lighthouse/OWA LABS partner card vs. G80-Plate)
