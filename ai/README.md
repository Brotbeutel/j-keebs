...
**After finishing work:** update `STATUS.md` and check off / move items in `BACKLOG.md`. If you made a lasting product or architecture choice, add it to [DECISIONS.md](DECISIONS.md). Do not leave the only record of the work in the chat.
