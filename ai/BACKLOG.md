...
- [ ] **Med — Node ≥ 22 becomes a requirement with P2-E** (`@11ty/eleventy-img` 7.x). `readme.md` currently says "Node.js 18 or newer (CI uses 22)"; update it in P2-E.
